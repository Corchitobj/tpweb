...
namespace tpweb.Data
{
    public class AppDbContext: DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("workstation id=OWLEDGE.mssql.somee.com;packet size=4096;user id=gcejas_SQLLogin_1;pwd=v9d84vgv4b;data source=OWLEDGE.mssql.somee.com;persist security info=False;initial catalog=OWLEDGE;TrustServerCertificate=True");
        }
